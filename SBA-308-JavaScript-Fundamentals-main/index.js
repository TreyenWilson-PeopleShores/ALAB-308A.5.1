...
const AssignmentGroup = external.assignmentGroups(); 
...
function getLearnerData(course, ag, submissions) {
    ...
    // MAKE SURE TO ALSO CHECK ALL ASSIGNMENTS, also the 3rd assignment
          ...
          let organizeByLearners = {};
            for(let info of learners2){ // This loop is organzing assignments by learners
            ...
            for (let learner_ID in organizeByLearners){
              ...
              for(let info of organizeByLearners[learner_ID]){
                ...
                if(info.due>new Date()){
                  ...
                  let penaltyScore = calculateScore(info.score, info.points_possible, true);
                  ...
                  let points_possible = info.points_possible;
                }
          ...
          let organizeLearners2 = {}; // This will organize the FINAL learners to prepare for result
            for(let info of learners){ // This loop is organzing assignments by learners
                let id = info.id;
            ...
            for (let learner_id in organizeLearners2){
             ...
             //   console.log("test", Object.keys(info));
              //  console.log("HERE", info);
                let assignment_ids = Object.keys(info)
                let assignment_id = assignment_ids[0];
